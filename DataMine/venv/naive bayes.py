...
from sklearn.naive_bayes import GaussianNB, MultinomialNB,ComplementNB,BernoulliNB,BaseDiscreteNB,BaseNB,CategoricalNB
...
naiveBayes = ComplementNB(alpha=1.1)
